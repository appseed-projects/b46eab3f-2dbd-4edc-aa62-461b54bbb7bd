...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-16 13:00`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b46eab3f-2dbd-4edc-aa62-461b54bbb7bd.git
$ cd b46eab3f-2dbd-4edc-aa62-461b54bbb7bd
```
